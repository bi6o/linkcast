...
+(function(a) {
    ...
    (d.VERSION =
        "3.3.7"), (d.TRANSITION_DURATION = 150), (d.prototype.close = function(
        b
    ) {
        function c() {
        ...
        if (b.length) {
            ...
            "radio" == c.prop("type")
                ...
                : "checkbox" == c.prop("type") &&
                  ...
                  ), c.prop("checked", this.$element.hasClass("active")), a &&
                c.trigger("change");
        } else
            this.$element.attr(
                "aria-pressed",
    ...
    (c.VERSION =
        "3.3.7"), (c.TRANSITION_DURATION = 300), (c.BACKDROP_TRANSITION_DURATION = 150), (c.DEFAULTS = {
        backdrop: !0,
        keyboard: !0,
        show: !0
    ...
    (c.VERSION = "3.3.7"), (c.TRANSITION_DURATION = 150), (c.DEFAULTS = {
        ...
        if (
            ...
            return clearTimeout(c.timeout), (c.hoverState = "out"), c.options
        ...
        clearTimeout(this.timeout), this.hide(function() {
            a.$element
                ...
                .removeData(
                    "bs." + a.type
                ), a.$tip && a.$tip.detach(), (a.$tip = null), (a.$arrow = null), (a.$viewport = null), (a.$element = null);
        });
    });
    var d = a.fn.tooltip;
    ...
    (c.VERSION = "3.3.7"), (c.DEFAULTS = a.extend(
        ...
        a
            .find(".popover-title")
            [this.options.html ? "html" : "text"](b), a
