!(function(a, b, c, d) {
    "use strict";
    function e(b, c) {
        (g = this), (this.element = a(b)), (this.options = a.extend(
            {},
            h,
            c
    ...
    (e.prototype.init = function() {
        ...
        c.on("mousedown touchstart", function(d) {
            if (!g.isTouch() || "mousedown" !== d.type) {
                c.find(".ripple-wrapper").length ||
                    c.append('<div class="ripple-wrapper"></div>');
        ...
        return g.isTouch()
            ? (
                  (b = b.originalEvent),
                  1 !== b.touches.length ? b.touches[0].pageX - c.left : !1
              )
            : b.pageX - c.left;
        ...
        return g.isTouch()
            ? (
                  (b = b.originalEvent),
                  1 !== b.touches.length ? b.touches[0].pageY - c.top : !1
              )
            : b.pageY - c.top;
    }), (e.prototype.getRipplesColor = function(a) {
        var c = a.data("ripple-color")
            ? a.data("ripple-color")
            : b.getComputedStyle(a[0]).color;
        return c;
        ...
        a.data("animating", "off"), "off" === a.data("mousedown") &&
            g.rippleOut(a);
    }), (e.prototype.rippleOut = function(a) {
        a.off(), g.hasTransitionSupport()
            ? a.addClass("ripple-out")
            ...
            : b.animate(
                  {
                      ...
                      "margin-left":
                          -1 * Math.max(a.outerWidth(), a.outerHeight()),
                      "margin-top":
                          -1 * Math.max(a.outerWidth(), a.outerHeight()),
                      opacity: 0.2
                  },
